...
## 🎯 Project Overview
**TransitNet-MAS** is a decentralized simulation of an urban public transportation system. Unlike traditional centralized schedulers, this project utilizes **Agent-Oriented Programming (AOP)** where every entity—station, vehicle, passenger, and traffic light—is an autonomous agent.
